...
export type AbilityClass = {
	...
	Hit: (self: AbilityClass, Caster: Caster, Target: Target, Data: {HitstopDuration: number, EffectData: HitVFXData, NoCameraShake: boolean, NoHitStop: boolean, NoAnim: boolean, NoVFX: boolean, StopEffect: any}) -> (),
}
