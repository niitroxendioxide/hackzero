...
function Ultimate:Sequence(Agent: AgentTypes.AgentClass)
    ...
    Ultimate:SetFOV(40, {.133, 'Linear'})
    task.delay(.133, function()
        Ultimate:SetFOV(37, {.1, 'Linear'})
        task.wait(.1)
        Ultimate:SetFOV(33.894, {.1, 'Linear'})
        task.wait(.1)
        Ultimate:SetFOV(31.623, {.1, 'Linear'})
        task.wait(.1)
        Ultimate:SetFOV(30, {.1, 'Linear'})
        task.wait(.467)
        Ultimate:SetFOV(38, {.1, 'Linear'})
        task.wait(.1)
        Ultimate:SetFOV(60, {.1, 'Linear'})
        task.wait(.1)
        Ultimate:SetFOV(70, {.05, 'Linear'})
    end)
