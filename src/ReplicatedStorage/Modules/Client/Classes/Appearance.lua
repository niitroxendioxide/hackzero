...
local EffectsUtil = require(Client.Utility.Effects)

--
local AppearanceClass = {} :: {[name]: (self: Types.AppearanceController, any) -> (), new: (ModelName: string) -> Types.AppearanceController}
...
function AppearanceClass.new(ModelName: string): Types.AppearanceController
	...
	local self = setmetatable({}, AppearanceClass) :: Types.AppearanceController
	...
	-- Saving values
	self.__Model.Parent = workspace.World.Entities.Appearances
